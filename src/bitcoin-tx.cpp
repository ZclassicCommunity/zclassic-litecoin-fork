...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " zclassic-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  zclassic-tx [options] <hex-tx> [commands]  Update hex-encoded zclassic transaction\n" +
            "or:     zclassic-tx [options] -create [commands]   Create hex-encoded zclassic transaction\n" +
            "\n";
