...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.zclassic.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.zclassictools.com");
        vSeeds.emplace_back("dnsseed.zclassicpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.zclassictools.com");
        vSeeds.emplace_back("seed-b.zclassic.loshan.co.uk");
