Contributing to Zclassic Core
============================

The Zclassic Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Zclassic Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/zclassic-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to zclassic-qt
...
The following applies to code changes to the Zclassic Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Zclassic
Network Protocol consensus changes.

Whether a pull request is merged into Zclassic Core rests with the project merge
...
Patches that change Zclassic consensus rules are considerably more involved than
...
Where a patch set proposes to change the Zclassic consensus, it must have been
...
The project leader is the release manager for each Zclassic Core release.
