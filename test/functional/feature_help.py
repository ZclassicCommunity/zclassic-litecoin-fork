...
"""Verify that starting zclassic with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start zclassic with -h for help text")
        ...
        self.log.info("Start zclassic with -version for version information")
        ...
        self.log.info("Start zclassicd with -fakearg to make sure it does not start")
