# Support for Output Descriptors in Zclassic Core

Since Zclassic Core v0.17, there is support for Output Descriptors. This is a
...
existing Zclassic Core wallets, a convenience function `combo` is
